  ...
  public class UpdateValidator : AbstractValidator<Dtos.Update>
  {
    public UpdateValidator()
    {
      ...
      RuleFor(x => x.StreetAddress)
        .MaximumLength(255).WithErrorCode(ErrorCodes.ERR_TOO_LONG)
        .WithMessage("StreetAddress cannot exceed 255 characters")
        .When(x => x.StreetAddress != null);
      ...
      RuleFor(x => x.PartnerType)
        .MaximumLength(255).WithErrorCode(ErrorCodes.ERR_TOO_LONG)
        .WithMessage("PartnerType cannot exceed 255 characters")
        .When(x => x.PartnerType != null);
