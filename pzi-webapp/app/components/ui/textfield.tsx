...
const Input = React.forwardRef(({ className, ...props }: AriaInputProps, ref: React.Ref<HTMLInputElement>) => {
  return (
    <AriaInput
      ref={ref}
...
const TextArea = React.forwardRef(({ className, ...props }: AriaTextAreaProps, ref: React.Ref<HTMLTextAreaElement>) => {
  return (
    <AriaTextArea
      ref={ref}
      className={composeRenderProps(className, (className) =>
