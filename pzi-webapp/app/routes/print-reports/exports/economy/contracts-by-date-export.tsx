...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  if (!minDate && !maxDate) {
    throw new Response("Missing required parameter: minDate or maxDate", { status: 400 });
  }

  const requestBody: any = { minDate, maxDate };
  ...
  return new Response(xlsxBuffer, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename=smlouvy_datum_${timestamp}.xlsx`,
