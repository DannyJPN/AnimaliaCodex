/* ZA-36 -> Sestavy / Programy: Druhy - Historie */
...
export default function SpeciesHistory() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/species/species-history/${selectedSpeciesOption.key}`;
        ...
        <div>
          ...
          <CardFooter className="p-2 pt-0">
            <Button
              ...
              isDisabled={!selectedSpeciesOption}>
