/* ZA-100 -> Sestavy/Programy - Ekonomika - Krmne dny druhu */
...
export default function FeedingDaysReport() {
  ...
  const handleDownload = async () => {
    if (!selectedSpeciesOption || !dateFrom || !dateTo) return;
    ...
    const fileUrl = `/print-reports/economy/feeding-days?${new URLSearchParams(params as any).toString()}`;
        ...
        <div>
          ...
          <CardFooter className="p-2 pt-0">
            <Button
              ...
              isDisabled={!selectedSpeciesOption || !dateFrom || !dateTo}>
