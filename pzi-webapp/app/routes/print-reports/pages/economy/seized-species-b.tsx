/* ZA-101b -> Sestavy/Programy - Ekonomika - Zabavené druhy ke dni (bezobratlí) */
...
export default function SeizedSpeciesBReport() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/economy/seized-species-b?${new URLSearchParams(params).toString()}`;
