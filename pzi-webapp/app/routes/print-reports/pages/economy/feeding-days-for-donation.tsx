/* ZA-101 -> Sestavy / Ekonomika - Krmne dny pro dotaci */
...
export default function FeedingDaysForDonationReport() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/economy/feeding-days-for-donation?${new URLSearchParams(params as any).toString()}`;
