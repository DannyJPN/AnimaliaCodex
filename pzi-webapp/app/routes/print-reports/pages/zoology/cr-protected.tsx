...
export default function CrProtectedReport() {
  ...
  const handleDownload = async () => {
    ...
    const params = {
      protectionType: 'crprotection'
    };

    await downloadFile(`/print-reports/zoology/cr-protected?${new URLSearchParams(params as any).toString()}`);
  };
