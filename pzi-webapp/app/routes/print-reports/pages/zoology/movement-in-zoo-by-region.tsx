...
export default function MovementInZooByRegionReport() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/zoology/movement-in-zoo-by-region?${new URLSearchParams(params as any).toString()}`;
