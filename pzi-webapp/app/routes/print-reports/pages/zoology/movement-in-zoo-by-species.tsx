...
export default function MovementInZooBySpeciesReport() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/zoology/movement-in-zoo-by-species?${new URLSearchParams(params as any).toString()}`;
        ...
        <div>
          ...
          <CardFooter className="p-2 pt-0">
            <Button
              ...
              isDisabled={ isDownloading || !minDate || !maxDate}>
