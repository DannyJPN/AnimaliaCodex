/* ZA-48 -> Sestavy / Zoologie - V majetku (hromadne) s reg. povinn. */
...
export default function InZooBulkRegOnlyReport() {
  ...
  const handleDownload = async () => {
    ...
    const mode = InZooFilterMode.Reg;

    var fileUrl =  `/print-reports/zoology/in-zoo-bulk/${selectedClassOption.key}?mode=${mode}`;
