...
export default function RegistrationsListReport() {
  ...
  const handleDownload = async () => {
    // Create URL parameters manually to preserve spaces
    const params = new URLSearchParams();
    params.append('minReg', minRegNumber.trim());
    params.append('maxReg', maxRegNumber.trim());
    
    const fileUrl = `/print-reports/zoology/registrations-list-by-eu-permit?${params}`;
