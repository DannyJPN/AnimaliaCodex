/* ZA-40 Sestavy / Zoologie - Pohyb v obdobi s vlivem na stav v zoo (P3)*/
...
export default function InventoryMovementsWithInfluenceReport() {
  ...
  const handleDownload = async () => {
    ...
    const params = {
      minDate: dateFrom,
      maxDate: dateTo,
      stateInfluence: StateInfluenceMode.WithInfluence
    };
