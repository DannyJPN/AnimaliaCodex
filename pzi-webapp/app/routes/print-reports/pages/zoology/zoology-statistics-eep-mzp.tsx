...
export default function StatisticsAsOfDateReport() {
  ...
  const handleDownload = async () => {
    ...
    var exportLink = `/print-reports/zoology/zoology-statistics-eep-mzp?${new URLSearchParams(params as any).toString()}`;
