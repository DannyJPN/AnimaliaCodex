/* ZA-281 -> Frontend - Sestavy / Programy: Exempláře - Registrace (P2) */
...
export default function RegisteredEuPermit() {
  ...
  const handleDownload = async () => {
    ...
    const fileUrl = `/print-reports/specimen/specimen-registration?${new URLSearchParams(params as any).toString()}`;
