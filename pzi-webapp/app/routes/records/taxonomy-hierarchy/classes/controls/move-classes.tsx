...
import { action as moveClassesAction } from '../operations/move-classes';

export function MoveClasses(props: {
  selectedIds: number[],
  ...
  const parentQuery = useQuery({
    queryKey: ['phyla-search', parentSearchQueryDebounced, props.currentParentId],
  ...
  return (
    <DialogOverlay
      ...
      <DialogContent
        ...
        <submitFetcher.Form
          method="post"
          action="/records/classes/operations/move-classes"
