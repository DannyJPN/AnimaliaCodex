...
import { action as moveClassesAction } from '../operations/move-locations';

export function MoveLocations(props: {
  selectedIds: number[],
  ...
  return (
    <DialogOverlay
      ...
      <DialogContent
        ...
        <submitFetcher.Form
          method="post"
          action="/records/locations/operations/move-locations-exposition"
