...
export default function List() {
  ...
  const goToDetail = (id: number) => {
    navigate(`/records/exposition-hierarchy/locations/${loaderData.locationId}/species/${id}${locationUse.search}`, { replace: true });
  }

  const goToChildren = (id: number) => {
    navigate(`/records/exposition-hierarchy/locations/${loaderData.locationId}/species/${id}/specimens`, { replace: true });
  }
