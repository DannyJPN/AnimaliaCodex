...
export default function Detail() {
    ...
    useEffect(() => {
        ...
        switch (fetcher.data?.action) {
          case 'delete': {
            navigate(`/records/org-hierarchy/departments/${location.search}`);
            break;
          }
          case 'insert': {
            navigate(`/records/org-hierarchy/departments/${fetcher.data.changeResult?.id}${location.search}`);
            break;
          }
        }
            ...
            <fetcher.Form method="POST" className="flex flex-col h-full">
                <FormValidationContext.Provider value={fetcher.data?.validationErrors || {}}>
                    ...
                    <ItemListNavigation
                        ...
                        getItemLink={(itm) => {
                            return `/records/org-hierarchy/departments/${itm.id}${location.search}`
                        }} />
