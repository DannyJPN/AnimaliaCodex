...
import { action as moveClassesAction } from '../operations/move-workplaces';

export function MoveWorkplaces(props: {
  selectedIds: number[],
  ...
  const parentQuery = useQuery({
    queryKey: ['workplaces-search', parentSearchQueryDebounced, props.currentParentId],
  ...
  return (
    <DialogOverlay
      ...
      <DialogContent
        ...
        <submitFetcher.Form
          method="post"
          action="/records/workplaces/operations/move-workplaces"
